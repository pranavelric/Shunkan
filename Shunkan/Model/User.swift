...
extension User{
    static var MOCK_USERS: [User] = [
        ...
        .init(id: "3", username: "alice",fullName: "Alice Elric", email: "alice@example.com",  profilePictureURL: "https://mobcup.net/images/wt/04caba7a86280e1096db24e6ec8eb1f1.jpg", bio: "Art lover and painter.", stories: [], highlights: [], friends: [], followers: [], following: [], posts: []),
        
        .init(id: "4", username: "Test",fullName: "lorem ipsum", email: "test@example.com",  profilePictureURL: nil, bio: "new user.", stories: [], highlights: [], friends: [], followers: [], following: [], posts: [])
