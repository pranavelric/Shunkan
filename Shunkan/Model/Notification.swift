...
extension Notification {
    static var MOCK_Notifications: [Notification] = [
        Notification(id: "1", type: .like, sender: User(id: "1", username: "johndoe", email: "john@example.com",  profilePictureURL:  "https://example.com/user1.jpg", bio: "I love photography.", stories: [], highlights: [], friends: [], followers: [], following: [], posts: []),  receiver: User(id: "2", username: "janedoe", email: "jane@example.com",  profilePictureURL:  "https://example.com/user2.jpg", bio: "Travel enthusiast and foodie.", stories: [], highlights: [], friends: [], followers: [], following: [], posts: []) , timestamp: Date(), isRead: false, object: NotificationObject(id:"1",objectID: "1",objectType:"post")),
        
        Notification(id: "2", type: .comment, sender: User(id: "2", username: "janedoe", email: "jane@example.com",  profilePictureURL: "https://example.com/user2.jpg", bio: "Travel enthusiast and foodie.", stories: [], highlights: [], friends: [], followers: [], following: [], posts: []), receiver:  User(id: "1", username: "johndoe", email: "john@example.com",  profilePictureURL: "https://example.com/user1.jpg", bio: "I love photography.", stories: [], highlights: [], friends: [], followers: [], following: [], posts: []), timestamp: Date(),  isRead: true, object: NotificationObject(id:"2",objectID: "2",objectType:"post")),
        Notification(id: "3", type: .follow, sender: User(id: "1", username: "johndoe", email: "john@example.com",  profilePictureURL:  "https://example.com/user1.jpg", bio: "I love photography.", stories: [], highlights: [], friends: [], followers: [], following: [], posts: []), receiver: nil , timestamp: Date(), isRead: false, object: nil),
